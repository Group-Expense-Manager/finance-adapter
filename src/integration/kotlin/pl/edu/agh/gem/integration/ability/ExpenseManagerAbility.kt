...
fun stubExpenseManagerActivities(
    body: Any?,
    groupId: String,
...
private fun createAcceptedExpensesUrl(
    groupId: String,
    currency: String,
) = "$INTERNAL/expenses/accepted/groups/$groupId?currency=$currency"

fun stubAcceptedExpenses(
    body: Any?,
    groupId: String,
